            ...
            <div class="page-content">
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="Javascript:;">Daily Expenses</a>
                        </li>
                    </ul>
                    <ul class="page-breadcrumb pull-right">
                        <li>
                            <a href="<?php echo base_url(); ?>expense-list/daily" class="btn btn-primary btn-xs color-white">
                            ...
                            <div class="portlet-body">
                                <div class="table-scrollable">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                        <form action="<?php echo base_url(); ?>list-daily-expense" method="post">
                                            <tr>
                                                <td>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . 'update-expense-list/daily/' . $expense->expense_list_id; ?>"
                                                           data-toggle="tooltip" title="Edit Details">
                                                            <?php echo $expense->expense_title; ?>
                                                        </a>
                                                    </td>
                                                    <td>Rs. <?php echo $expense->total; ?></td>
                                                    <td><?php echo date("M / Y",strtotime($expense->expense_month)); ?></td>
                                                    <td>
                                                        <a href="javascript:;" class="btn blue btn-xs add-btn"
                                                           title="Add daily expense to list" data-toggle="tooltip"
                                                           data-title="<?php echo $expense->expense_title; ?>"
                                                           data-id="<?php echo $expense->expense_list_id; ?>" data-min="<?php echo date("Y-m",strtotime($expense->expense_month));?>" data-max="<?php echo cal_days_in_month(CAL_GREGORIAN,date("m",strtotime($expense->expense_month)),date("Y",strtotime($expense->expense_month)));?>">
                        ...
                        <div class="table-scrollable">
                            <table id="items-table" class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="item-date" type="date" name="item_date[]" class="form-control input-sm"
...
<script type="text/javascript">
    ...
    $(document).on('click', '.add-btn', function () {
        ...
        var min_date = $(this).attr('data-min') + '-01';
        var max_date = $(this).attr('data-min') + '-' + $(this).attr('data-max');
        $('#items-table tbody tr td input[type="date"]').attr('min',min_date);
        $('#items-table tbody tr td input[type="date"]').attr('max',max_date);
    ...
    $(document).on('click', '#add-row', function () {
        var min = $('#item-date').attr('min');
        var max = $('#item-date').attr('max');
        var html = '';
        ...
        html += '<tr><input type="hidden" name="expense_details_id[]" value="0">' +
            ...
            '<td><input type="date" name="item_date[]" value="<?php echo $exp_date;?>" class="form-control input-sm" min="'+min+'" min="'+max+'"/></td>' +
